            ...
            <div className=' mt-lg-5 pt-lg-5 mt-md-5 pt-md-5 mt-5 pt-3'>
                                    ...
                                    <div className='col-3'>
                                        <div className="card mt-5 mt-lg-0 border border-1 rounded-0 Offeringscard">
                                            <div className="card-body cardcolor p-4">
                                                ...
                                                <p className="card-text fw-light">Our product engineering team stacks up your requirements
                                                    Into a market-ready product in rapid timelines, increasing speed to market dramatically.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col-3'>
                                        <div className="card mt-5 mt-lg-0 border border-1 rounded-0 Offeringscard">
                                            <div className="card-body cardcolor p-4">
                                                ...
                                                <p className="card-text fw-light mb-lg-4">Our approach to building IT products and platforms always sees our clients future, Now, making them future ready.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col-3'>
                                        <div className="card mt-5 mt-lg-0 border border-1 rounded-0 Offeringscard" >
                                            <div className="card-body cardcolor p-4">
                                                ...
                                                <p className="card-text fw-light">Our experienced team and deep expertise in developing it products, radically brings down the cost factor, making a lean path to building disruptive products.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className='col-12'>
                                        <div className="card mt-5 mt-lg-0 border border-2 rounded-0">
                                            <div className="card-body cardcolor p-4">
                                                ...
                                                <p className="card-text fw-light mb-5">Our approach to building IT products and platforms always sees our clients future, Now, making them future ready.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='col-12'>
                ...
                <div className='container mt-lg-5  pt-lg-5'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-12 col-md-7 col-lg-7'>
                            ...
                            Unbox your product journey with us to witness new age technologies powering NextGen products for future-ready business.
                            </p>
                ...
                <div className='container-fluid'>
                    <div className='row py-lg-5 py-md-5'>
                        <div className='col-12  col-lg-5 py-lg-5 py-md-5 '>
                            <img src={product} className='img-fluid col-9' alt='product and developement' />
                        </div>
                ...
                <div className='container mt-5'>
                    <div className='row '>
                        <div className='col-12 col-lg-6'>
                            <p className='fs-6'>
                            Power your engagement with Customers through world-class user experiences and high impact user touch points.
                            </p>
                            <hr className='mt-lg-5 d-none d-sm-none d-md-block d-lg-block' />
                        ...
                        <div className='col-12 col-lg-6  d-none d-sm-none d-md-none d-lg-block'>
                            <img src={experiencedesign} className='img-fluid col-9' alt='product and developement' />
                        </div>
                    </div>
                </div>
                <div className='container'>
                ...
                <div className='container mt-5'>
                    <div className='row pe-lg-5'>
                        <div className='col-12 col-lg-5 px-5'>
                            <img src={custom} className='img-fluid' alt='product and developement' width='100%'/>
                        </div>
                        <div className='col-12 col-lg-7'>
                            <div className='row'>
                                <div className='col-12 col-lg-12 pt-5 pt-lg-0'>
                                    <p className='fs-6'>
                                    Hyper personalize your applications and products through our modular and agile approach. Embrace variety at scale and speed! 
                                    </p>
                ...
                <div className='container my-lg-5'>
                    ...
                    <div className='row mt-lg-2 py-lg-5'>
                        <div className='col-12 col-lg-7'>
                            <div className='row'>
                                <div className='col'>
                                    <p className=''>Deliver quality products and services, first time and every time with our top-class Engineering & Testing tailed just for you.
                                    </p>
                                    <hr className='mt-lg-5 d-none d-sm-none d-md-block d-lg-block' />
                                </div>
                            </div>
                        ...
                        <div className='col-5 d-none d-sm-none d-md-none d-lg-block'>
                            <img src={engineering} className='img-fluid col-10' alt='experience design' />
                        </div>
                    </div>
                </div>
                <div className='container'>
                ...
                <div className='container my-lg-5'>
                    ...
                    <div className='row mt-lg-5'>
                        <div className='col-12 col-lg-5'>
                            <img src={analtics} className='img-fluid mt-lg-3 col-11' alt='custom developement' />
                        </div>
                        <div className='col-12 col-lg-7 px-lg-5 mt-3'>
                            <div className='row'>
                                <div className='col'>
                                    <p className='fs-6'>Energize your data for executive decision making, proactive customer engagement and prudent leverage of resources through our deep tech AI & Analytics stack.
                                    </p>
                                    <hr className='mt-lg-4 d-none d-sm-none d-md-block d-lg-block' />
                                </div>
                            </div>
